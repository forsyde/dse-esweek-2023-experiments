...
def plot_complexity_barriers(complex_data: pd.DataFrame, plot_name="complexity_barrier"):
    ...
    cs = ax.contourf(xvalues, yvalues, zvalues.values / 1000.0, [1, 60, 3600, 3600*8, 3600*24, 3600*24*5], cmap="PuRd", locator=mpl.ticker.LogLocator())
    ...
    cbar.set_label("$\log_{{10}}$ runtime")
